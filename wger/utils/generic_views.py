...
class WgerPermissionMixin(object):
    ...
    This can be a string or a tuple, in the latter
    case having any of the permissions
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        # Dispatch normally
        return super(
            WgerPermissionMixin, self).dispatch(request, *args, **kwargs)
...
class WgerFormMixin(ModelFormMixin):
    ...
    def form_valid(self, form):
        ...
        for field in self.clean_html:
            setattr(form.instance, field, bleach.clean(getattr(
                form.instance, field),
