...
class ExerciseIndexTestCase(WorkoutManagerTestCase):
    ...
    def exercise_index(self, logged_in=True,
                       demo=False, admin=False):
        '''
    ...
    def test_exercise_index_logged_out(self):
        '''
        Tests the exercise overview page as an
...
class ExerciseDetailTestCase(WorkoutManagerTestCase):
    ...
    def test_exercise_detail_non_editor(self):
        '''
        Tests the exercise details page as a logged
...
class ExercisesTestCase(WorkoutManagerTestCase):
    ...
    def test_add_exercise_no_user(self):
        '''
        Tests adding an exercise with a logged out
        (anonymous) user
        '''
    ...
    def test_add_exercise_user_no_rights(self):
        '''
        Tests adding an exercise with a user
        without enough rights to do this
        '''
        self.user_login('test')
...
class ExercisesCacheTestCase(WorkoutManagerTestCase):
    ...
    def test_exercise_overview(self):
        '''
        Test the exercise overview cache is correctly
        generated on visit
        '''
        if self.is_mobile:
            self.assertFalse(
                cache.get(get_template_cache_name(
    ...
    def test_exercise_detail(self):
        '''
        Test that the exercise detail cache is
    ...
    def test_overview_cache_update(self):
        ...
        if not self.is_mobile:
            ...
            self.assertNotEqual(
                old_exercise_overview, new_exercise_overview)
            self.assertNotEqual(
                old_muscle_overview, new_muscle_overview)
        else:
