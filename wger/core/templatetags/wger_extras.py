...
def get_current_settings(exercise, set_id):
    ...
    the template, and we are only interested on
     the settings that belong to the current
    set
    '''
...
def auto_link_css(flavour='full', css=''):
    '''
    Adds the appropriate classes to
     a sidebar link depending on the site version
...
def trans_weight_unit(
    ...
    :param user: the user object,
     needed to access the profile. If this evaluates
...
def form_field_add_css(field, css):
    ...
    Adds a CSS class to a form field.
     This is needed among other places for
